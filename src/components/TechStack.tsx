  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center text-white mb-16">
        <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-[3.25rem] lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 tracking-tight mb-6">
          Tech Stack
        </h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 text-white">
        {techStack.map((tech, index) => (
          <div
            key={index}
            className="flex flex-col items-center justify-center p-4 border border-neutral-700 rounded-full bg-neutral-900/40 hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300"
          >
