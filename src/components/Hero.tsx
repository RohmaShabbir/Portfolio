...
const Hero = () => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(to bottom, rgba(38, 38, 38, 0.1), transparent)",
      }}
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-10">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full lg:w-1/2 relative">
          ...
          <p className="text-gray-300 mt-5 sm:mt-6 md:mt-8 text-sm xs:text-base sm:text-lg leading-relaxed px-4 sm:px-6 py-2 rounded-xl max-w-md md:max-w-none">
            I design modern web interfaces and build smart AI-powered
            applications. Currently As a student at GIAIC, I’m passionate about
            merging creativity with technology to shape the digital future.
          </p>
          ...
          <div className="flex lg:px-20 justify-center md:px-8 gap-4 sm:gap-5 md:gap-6 mt-6 sm:mt-8 md:mt-10 text-white text-xl sm:text-2xl relative z-10">
            <a
              href="https://x.com/X_Rohma?t=J9w1eXHOfDLlpBhWdJ4yuA&s=08"
              target="_blank"
            ...
            <a
              href="/Rohma Shabbir.pdf"
              download="Rohma Shabbir.pdf"
              className="p-2 sm:p-3 rounded-full transition-all duration-300 hover:border-purple-400/30"
              style={{
                backgroundColor: "rgba(38, 38, 38, 0.5)",
                border: "1px solid rgba(55, 65, 81, 0.5)",
            ...
            >
              <TbFileCv className="hover:text-purple-300 transition" />
            </a>
          </div>
        </div>
        ...
        <div className="hidden lg:flex justify-center mt-8 lg:mt-0 w-full lg:w-1/2">
          <div className="relative w-40 h-40 xs:w-48 xs:h-48 sm:w-56 sm:h-56 md:w-60 md:h-60 lg:w-64 lg:h-64">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(16, 185, 129, 0.2), rgba(168, 85, 247, 0.3), rgba(236, 72, 153, 0.2)",
                filter: "blur(20px)",
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(168, 85, 247, 0.2), rgba(236, 72, 153, 0.1))",
                border: "1px solid rgba(55, 65, 81, 0.5)",
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(16, 185, 129, 0.05), rgba(168, 85, 247, 0.1), rgba(236, 72, 153, 0.05))",
